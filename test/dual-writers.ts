...
ava('dual-writers individual file', async t => {
  ...
  for (const ws of [ws1, ws2]) {
    ...
    }
    {
      ...
      if (info) {
        ...
        t.truthy(history[0].writer.equals(writer1.publicKey))
  ...
  for (const ws of [ws1, ws2]) {
    ...
    }
    {
      ...
      if (info) {
        ...
        t.truthy(history[1].writer.equals(writer2.publicKey))
  ...
  for (const ws of [ws1, ws2]) {
    ...
    }
    {
      ...
      t.truthy(history[2].writer.equals(writer1.publicKey))
